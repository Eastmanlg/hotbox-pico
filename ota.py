# Description: This module handles OTA updates. It connects to the Wi-Fi, checks for updates, downloads and installs them.
# Original File: https://github.com/kevinmcaleer/ota/blob/main/ota.py
# Original Author: Kevin McAleer
